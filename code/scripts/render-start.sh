...
if [ "$free_tier_safe" = "true" ]; then
  ...
  export DAILY_OUTBOUND_SMALL_MAX_MAPS_LIMIT="$(int_between "${DAILY_OUTBOUND_SMALL_MAX_MAPS_LIMIT:-}" 0 0 2)"
  export DAILY_OUTBOUND_SMALL_MAX_PUBLIC_SEARCH_LIMIT="$(int_between "${DAILY_OUTBOUND_SMALL_MAX_PUBLIC_SEARCH_LIMIT:-}" 5 0 10)"
  export DAILY_OUTBOUND_SMALL_MAX_LEAD_SCOUT_LIMIT="$(int_between "${DAILY_OUTBOUND_SMALL_MAX_LEAD_SCOUT_LIMIT:-}" 20 1 40)"
  ...
  export FREE_MAIL_PUMP_INITIAL_DELAY_MS="$(int_between "${FREE_MAIL_PUMP_INITIAL_DELAY_MS:-}" 60000 30000 180000)"
  ...
  export FREE_MAIL_PUMP_LEAD_SCOUT_LIMIT="$(int_between "${FREE_MAIL_PUMP_LEAD_SCOUT_LIMIT:-}" 20 1 40)"
  export FREE_MAIL_PUMP_PUBLIC_SEARCH_LIMIT="$(int_between "${FREE_MAIL_PUMP_PUBLIC_SEARCH_LIMIT:-}" 5 0 10)"
  ...
  export FREE_MAIL_PUMP_DISCOVERY_SOURCE_MODE="${FREE_MAIL_PUMP_DISCOVERY_SOURCE_MODE:-lead_scout}"
fi
...
if enabled_flag "${WEB_EMBED_FREE_MAIL_PUMP:-$free_mail_pump_default}"; then
  ...
  start_background "free-mail-pump" env \
    ...
    FREE_MAIL_PUMP_INITIAL_DELAY_MS="${FREE_MAIL_PUMP_INITIAL_DELAY_MS:-60000}" \
    FREE_MAIL_PUMP_SEND_LIMIT="${FREE_MAIL_PUMP_SEND_LIMIT:-5}" \
    FREE_MAIL_PUMP_APPROVE_LIMIT="${FREE_MAIL_PUMP_APPROVE_LIMIT:-25}" \
    FREE_MAIL_PUMP_LEAD_SCOUT_LIMIT="${FREE_MAIL_PUMP_LEAD_SCOUT_LIMIT:-20}" \
    FREE_MAIL_PUMP_PUBLIC_SEARCH_LIMIT="${FREE_MAIL_PUMP_PUBLIC_SEARCH_LIMIT:-5}" \
    ...
    FREE_MAIL_PUMP_DISCOVERY_SOURCE_MODE="${FREE_MAIL_PUMP_DISCOVERY_SOURCE_MODE:-lead_scout}" \
