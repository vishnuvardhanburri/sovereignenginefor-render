        ...
        ? await importContacts(clientId, {
            contacts: scrape.found.map((result) => ({
              ...
              customFields: {
                ...
                research_evidence_url: result.sourceUrl,
                ...
                research_summary: result.evidenceSummary,
                reason_to_contact: result.evidenceSummary,
                public_signals: result.publicSignals,
                public_phone_numbers: result.phoneNumbers,
                public_pages_scanned: result.discoveredPages,
              },
            })),
            verify: false,
            enrich: false,
