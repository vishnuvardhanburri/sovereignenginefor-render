...
const COMPANY_SEEDS: CompanySeed[] = [
  ...
  { company: 'SmartSites', domain: 'smartsites.com', industries: ['agency'], region: 'us', signals: ['digital marketing', 'lead generation'] },
  { company: 'Disruptive Advertising', domain: 'disruptiveadvertising.com', industries: ['agency'], region: 'us', signals: ['performance marketing', 'paid acquisition'] },
  { company: 'JumpFly', domain: 'jumpfly.com', industries: ['agency'], region: 'us', signals: ['paid search', 'performance marketing'] },
  { company: 'NP Digital', domain: 'npdigital.com', industries: ['agency'], region: 'global', signals: ['performance marketing', 'seo'] },
  { company: 'Intero Digital', domain: 'interodigital.com', industries: ['agency'], region: 'us', signals: ['digital marketing', 'revenue growth'] },
  { company: 'Scorpion', domain: 'scorpion.co', industries: ['agency'], region: 'us', signals: ['client acquisition', 'digital marketing'] },
  { company: 'HigherVisibility', domain: 'highervisibility.com', industries: ['agency'], region: 'us', signals: ['seo', 'lead generation'] },
  { company: 'Titan Growth', domain: 'titangrowth.com', industries: ['agency'], region: 'us', signals: ['seo', 'paid media'] },
  { company: 'Avalaunch Media', domain: 'avalaunchmedia.com', industries: ['agency'], region: 'us', signals: ['performance marketing', 'content marketing'] },
  { company: 'Mad Fish Digital', domain: 'madfishdigital.com', industries: ['agency'], region: 'us', signals: ['digital marketing', 'paid media'] },
  { company: 'NoGood', domain: 'nogood.io', industries: ['agency'], region: 'us', signals: ['growth marketing', 'performance marketing'] },
  { company: 'Tuff Growth', domain: 'tuffgrowth.com', industries: ['agency'], region: 'us', signals: ['growth marketing', 'startup acquisition'] },
  { company: 'Ladder', domain: 'ladder.io', industries: ['agency'], region: 'global', signals: ['growth marketing', 'experimentation'] },
  { company: 'GrowthRocks', domain: 'growthrocks.com', industries: ['agency'], region: 'eu', signals: ['growth marketing', 'startup growth'] },
  { company: 'Powered by Search', domain: 'poweredbysearch.com', industries: ['agency'], region: 'global', signals: ['b2b saas marketing', 'demand generation'] },
  { company: 'Kalungi', domain: 'kalungi.com', industries: ['agency'], region: 'us', signals: ['b2b saas marketing', 'fractional marketing'] },
  { company: 'Walker Sands', domain: 'walkersands.com', industries: ['agency'], region: 'us', signals: ['b2b marketing', 'public relations'] },
  { company: 'Bop Design', domain: 'bopdesign.com', industries: ['agency'], region: 'us', signals: ['b2b web design', 'content marketing'] },
  { company: 'First Page Sage', domain: 'firstpagesage.com', industries: ['agency'], region: 'us', signals: ['seo', 'thought leadership'] },
  { company: 'Elevation Marketing', domain: 'elevationb2b.com', industries: ['agency'], region: 'us', signals: ['b2b marketing', 'demand generation'] },
  { company: 'Launch Marketing', domain: 'launch-marketing.com', industries: ['agency'], region: 'us', signals: ['b2b marketing', 'lead generation'] },
  { company: 'TREW Marketing', domain: 'trewmarketing.com', industries: ['agency'], region: 'us', signals: ['b2b marketing', 'technical buyers'] },
  { company: 'The Pedowitz Group', domain: 'pedowitzgroup.com', industries: ['agency'], region: 'us', signals: ['revenue marketing', 'marketing operations'] },
  { company: 'Heinz Marketing', domain: 'heinzmarketing.com', industries: ['agency'], region: 'us', signals: ['b2b demand generation', 'pipeline strategy'] },
  { company: 'Demand Spring', domain: 'demandspring.com', industries: ['agency'], region: 'global', signals: ['demand generation', 'marketing automation'] },
  { company: 'Spear Marketing Group', domain: 'spearmarketing.com', industries: ['agency'], region: 'us', signals: ['b2b demand generation', 'marketing automation'] },
  { company: 'Sercante', domain: 'sercante.com', industries: ['agency'], region: 'us', signals: ['marketing operations', 'pardot consulting'] },
  { company: 'Cheshire Impact', domain: 'cheshireimpact.com', industries: ['agency'], region: 'us', signals: ['salesforce consulting', 'marketing operations'] },
  { company: 'Revenue River', domain: 'revenueriver.co', industries: ['agency'], region: 'us', signals: ['hubspot consulting', 'revenue operations'] },
  { company: 'Kuno Creative', domain: 'kunocreative.com', industries: ['agency'], region: 'us', signals: ['inbound marketing', 'demand generation'] },
  { company: 'ProperExpression', domain: 'properexpression.com', industries: ['agency'], region: 'us', signals: ['b2b growth marketing', 'demand generation'] },
  { company: 'memoryBlue', domain: 'memoryblue.com', industries: ['agency'], region: 'us', signals: ['sales development', 'appointment setting'] },
  { company: 'EBQuickstart', domain: 'ebquickstart.com', industries: ['agency'], region: 'us', signals: ['sales outsourcing', 'customer acquisition'] },
  { company: 'SalesPipe', domain: 'salespipe.co', industries: ['agency'], region: 'global', signals: ['sales development', 'lead generation'] },
  { company: 'Pearl Lemon Leads', domain: 'pearllemonleads.com', industries: ['agency'], region: 'eu', signals: ['lead generation', 'appointment setting'] },
  { company: 'VSA Prospecting', domain: 'vsaprospecting.com', industries: ['agency'], region: 'us', signals: ['appointment setting', 'lead generation'] },
  { company: 'SalesAR', domain: 'salesar.io', industries: ['agency'], region: 'eu', signals: ['b2b lead generation', 'appointment setting'] },
  { company: 'Lead Genera', domain: 'leadgenera.com', industries: ['agency'], region: 'eu', signals: ['lead generation', 'digital marketing'] },
  { company: 'Lead Pronto', domain: 'leadpronto.co.uk', industries: ['agency'], region: 'eu', signals: ['lead generation', 'b2b marketing'] },
  { company: 'Gripped', domain: 'gripped.io', industries: ['agency'], region: 'eu', signals: ['b2b saas marketing', 'demand generation'] },
  { company: 'Modern', domain: 'modernb2b.co', industries: ['agency'], region: 'eu', signals: ['b2b marketing', 'demand generation'] },
  { company: 'The Marketing Practice', domain: 'themarketingpractice.com', industries: ['agency'], region: 'global', signals: ['b2b marketing', 'demand generation'] },
  { company: 'Transmission', domain: 'transmissionagency.com', industries: ['agency'], region: 'global', signals: ['b2b marketing', 'account based marketing'] },
  { company: 'MOI Global', domain: 'moi-global.com', industries: ['agency'], region: 'global', signals: ['b2b marketing', 'account based marketing'] },
  { company: 'Twogether', domain: 'wearetwogether.com', industries: ['agency'], region: 'eu', signals: ['b2b marketing', 'technology marketing'] },
  { company: 'Agent3', domain: 'agent3.com', industries: ['agency'], region: 'global', signals: ['account based marketing', 'b2b demand generation'] },
  { company: 'Earnest', domain: 'earnest-agency.com', industries: ['agency'], region: 'eu', signals: ['b2b marketing', 'creative demand generation'] },
  { company: 'Stein IAS', domain: 'steinias.com', industries: ['agency'], region: 'global', signals: ['b2b marketing', 'brand to demand'] },
